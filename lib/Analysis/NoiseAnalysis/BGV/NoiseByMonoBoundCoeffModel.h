#ifndef INCLUDE_ANALYSIS_NOISEANALYSIS_BGV_NOISEBYMONOBOUNDCOEFFMODEL_H_
#define INCLUDE_ANALYSIS_NOISEANALYSIS_BGV_NOISEBYMONOBOUNDCOEFFMODEL_H_
...
template<bool P>
class NoiseByMonoBoundCoeffModel {
 public:
...
using NoiseByMonoBoundCoeffPkModel = NoiseByMonoBoundCoeffModel<true>;
using NoiseByMonoBoundCoeffSkModel = NoiseByMonoBoundCoeffModel<false>;

}  // namespace bgv
}  // namespace heir
}  // namespace mlir

#endif  // INCLUDE_ANALYSIS_NOISEANALYSIS_BGV_NOISEBYMONOBOUNDCOEFFMODEL_H_
