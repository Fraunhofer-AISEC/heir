func.func @func(
  ...
  //-------------------------------------------------------------------------
  // Level 2: 63 additions (1 squaring with interleaved rotation)
  %c1 = arith.constant 1 : index
  %sq2_0 = arith.muli %arg0, %arg0 : tensor<8xi16>
  %sum2_1 = arith.addi %m1, %sq2_0 : tensor<8xi16>
  %rot2_1 = tensor_ext.rotate %sum2_1, %c1 : tensor<8xi16>, index
  %sq2_1 = arith.muli %arg1, %arg1 : tensor<8xi16>
  %sum2_2 = arith.addi %rot2_1, %sq2_1 : tensor<8xi16>
  %rot2_2 = tensor_ext.rotate %sum2_2, %c1 : tensor<8xi16>, index
  %sq2_2 = arith.muli %arg2, %arg2 : tensor<8xi16>
  %sum2_3 = arith.addi %rot2_2, %sq2_2 : tensor<8xi16>
  %rot2_3 = tensor_ext.rotate %sum2_3, %c1 : tensor<8xi16>, index
  %sq2_3 = arith.muli %arg3, %arg3 : tensor<8xi16>
  %sum2_4 = arith.addi %rot2_3, %sq2_3 : tensor<8xi16>
  %rot2_4 = tensor_ext.rotate %sum2_4, %c1 : tensor<8xi16>, index
  %sq2_4 = arith.muli %arg4, %arg4 : tensor<8xi16>
  %sum2_5 = arith.addi %rot2_4, %sq2_4 : tensor<8xi16>
  %rot2_5 = tensor_ext.rotate %sum2_5, %c1 : tensor<8xi16>, index
  %sq2_5 = arith.muli %arg5, %arg5 : tensor<8xi16>
  %sum2_6 = arith.addi %rot2_5, %sq2_5 : tensor<8xi16>
  %rot2_6 = tensor_ext.rotate %sum2_6, %c1 : tensor<8xi16>, index
  %sq2_6 = arith.muli %arg6, %arg6 : tensor<8xi16>
  %sum2_7 = arith.addi %rot2_6, %sq2_6 : tensor<8xi16>
  %rot2_7 = tensor_ext.rotate %sum2_7, %c1 : tensor<8xi16>, index
  %sq2_7 = arith.muli %arg7, %arg7 : tensor<8xi16>
  %sum2_8 = arith.addi %rot2_7, %sq2_7 : tensor<8xi16>
  %rot2_8 = tensor_ext.rotate %sum2_8, %c1 : tensor<8xi16>, index
  %sq2_8 = arith.muli %arg8, %arg8 : tensor<8xi16>
  %sum2_9 = arith.addi %rot2_8, %sq2_8 : tensor<8xi16>
  %rot2_9 = tensor_ext.rotate %sum2_9, %c1 : tensor<8xi16>, index
  %sq2_9 = arith.muli %arg9, %arg9 : tensor<8xi16>
  %sum2_10 = arith.addi %rot2_9, %sq2_9 : tensor<8xi16>
  %rot2_10 = tensor_ext.rotate %sum2_10, %c1 : tensor<8xi16>, index
  %sq2_10 = arith.muli %arg10, %arg10 : tensor<8xi16>
  %sum2_11 = arith.addi %rot2_10, %sq2_10 : tensor<8xi16>
  %rot2_11 = tensor_ext.rotate %sum2_11, %c1 : tensor<8xi16>, index
  %sq2_11 = arith.muli %arg11, %arg11 : tensor<8xi16>
  %sum2_12 = arith.addi %rot2_11, %sq2_11 : tensor<8xi16>
  %rot2_12 = tensor_ext.rotate %sum2_12, %c1 : tensor<8xi16>, index
  %sq2_12 = arith.muli %arg12, %arg12 : tensor<8xi16>
  %sum2_13 = arith.addi %rot2_12, %sq2_12 : tensor<8xi16>
  %rot2_13 = tensor_ext.rotate %sum2_13, %c1 : tensor<8xi16>, index
  %sq2_13 = arith.muli %arg13, %arg13 : tensor<8xi16>
  %sum2_14 = arith.addi %rot2_13, %sq2_13 : tensor<8xi16>
  %rot2_14 = tensor_ext.rotate %sum2_14, %c1 : tensor<8xi16>, index
  %sq2_14 = arith.muli %arg14, %arg14 : tensor<8xi16>
  %sum2_15 = arith.addi %rot2_14, %sq2_14 : tensor<8xi16>
  %rot2_15 = tensor_ext.rotate %sum2_15, %c1 : tensor<8xi16>, index
  %sq2_15 = arith.muli %arg15, %arg15 : tensor<8xi16>
  %sum2_16 = arith.addi %rot2_15, %sq2_15 : tensor<8xi16>
  %rot2_16 = tensor_ext.rotate %sum2_16, %c1 : tensor<8xi16>, index
  %sq2_16 = arith.muli %arg16, %arg16 : tensor<8xi16>
  %sum2_17 = arith.addi %rot2_16, %sq2_16 : tensor<8xi16>
  %rot2_17 = tensor_ext.rotate %sum2_17, %c1 : tensor<8xi16>, index
  %sq2_17 = arith.muli %arg17, %arg17 : tensor<8xi16>
  %sum2_18 = arith.addi %rot2_17, %sq2_17 : tensor<8xi16>
  %rot2_18 = tensor_ext.rotate %sum2_18, %c1 : tensor<8xi16>, index
  %sq2_18 = arith.muli %arg18, %arg18 : tensor<8xi16>
  %sum2_19 = arith.addi %rot2_18, %sq2_18 : tensor<8xi16>
  %rot2_19 = tensor_ext.rotate %sum2_19, %c1 : tensor<8xi16>, index
  %sq2_19 = arith.muli %arg19, %arg19 : tensor<8xi16>
  %sum2_20 = arith.addi %rot2_19, %sq2_19 : tensor<8xi16>
  %rot2_20 = tensor_ext.rotate %sum2_20, %c1 : tensor<8xi16>, index
  %sq2_20 = arith.muli %arg20, %arg20 : tensor<8xi16>
  %sum2_21 = arith.addi %rot2_20, %sq2_20 : tensor<8xi16>
  %rot2_21 = tensor_ext.rotate %sum2_21, %c1 : tensor<8xi16>, index
  %sq2_21 = arith.muli %arg21, %arg21 : tensor<8xi16>
  %sum2_22 = arith.addi %rot2_21, %sq2_21 : tensor<8xi16>
  %rot2_22 = tensor_ext.rotate %sum2_22, %c1 : tensor<8xi16>, index
  %sq2_22 = arith.muli %arg22, %arg22 : tensor<8xi16>
  %sum2_23 = arith.addi %rot2_22, %sq2_22 : tensor<8xi16>
  %rot2_23 = tensor_ext.rotate %sum2_23, %c1 : tensor<8xi16>, index
  %sq2_23 = arith.muli %arg23, %arg23 : tensor<8xi16>
  %sum2_24 = arith.addi %rot2_23, %sq2_23 : tensor<8xi16>
  %rot2_24 = tensor_ext.rotate %sum2_24, %c1 : tensor<8xi16>, index
  %sq2_24 = arith.muli %arg24, %arg24 : tensor<8xi16>
  %sum2_25 = arith.addi %rot2_24, %sq2_24 : tensor<8xi16>
  %rot2_25 = tensor_ext.rotate %sum2_25, %c1 : tensor<8xi16>, index
  %sq2_25 = arith.muli %arg25, %arg25 : tensor<8xi16>
  %sum2_26 = arith.addi %rot2_25, %sq2_25 : tensor<8xi16>
  %rot2_26 = tensor_ext.rotate %sum2_26, %c1 : tensor<8xi16>, index
  %sq2_26 = arith.muli %arg26, %arg26 : tensor<8xi16>
  %sum2_27 = arith.addi %rot2_26, %sq2_26 : tensor<8xi16>
  %rot2_27 = tensor_ext.rotate %sum2_27, %c1 : tensor<8xi16>, index
  %sq2_27 = arith.muli %arg27, %arg27 : tensor<8xi16>
  %sum2_28 = arith.addi %rot2_27, %sq2_27 : tensor<8xi16>
  %rot2_28 = tensor_ext.rotate %sum2_28, %c1 : tensor<8xi16>, index
  %sq2_28 = arith.muli %arg28, %arg28 : tensor<8xi16>
  %sum2_29 = arith.addi %rot2_28, %sq2_28 : tensor<8xi16>
  %rot2_29 = tensor_ext.rotate %sum2_29, %c1 : tensor<8xi16>, index
  %sq2_29 = arith.muli %arg29, %arg29 : tensor<8xi16>
  %sum2_30 = arith.addi %rot2_29, %sq2_29 : tensor<8xi16>
  %rot2_30 = tensor_ext.rotate %sum2_30, %c1 : tensor<8xi16>, index
  %sq2_30 = arith.muli %arg30, %arg30 : tensor<8xi16>
  %sum2_31 = arith.addi %rot2_30, %sq2_30 : tensor<8xi16>
  %rot2_31 = tensor_ext.rotate %sum2_31, %c1 : tensor<8xi16>, index
  %sq2_31 = arith.muli %arg31, %arg31 : tensor<8xi16>
  %sum2_32 = arith.addi %rot2_31, %sq2_31 : tensor<8xi16>
  %rot2_32 = tensor_ext.rotate %sum2_32, %c1 : tensor<8xi16>, index
  %sq2_32 = arith.muli %arg32, %arg32 : tensor<8xi16>
  %sum2_33 = arith.addi %rot2_32, %sq2_32 : tensor<8xi16>
  %rot2_33 = tensor_ext.rotate %sum2_33, %c1 : tensor<8xi16>, index
  %sq2_33 = arith.muli %arg33, %arg33 : tensor<8xi16>
  %sum2_34 = arith.addi %rot2_33, %sq2_33 : tensor<8xi16>
  %rot2_34 = tensor_ext.rotate %sum2_34, %c1 : tensor<8xi16>, index
  %sq2_34 = arith.muli %arg34, %arg34 : tensor<8xi16>
  %sum2_35 = arith.addi %rot2_34, %sq2_34 : tensor<8xi16>
  %rot2_35 = tensor_ext.rotate %sum2_35, %c1 : tensor<8xi16>, index
  %sq2_35 = arith.muli %arg35, %arg35 : tensor<8xi16>
  %sum2_36 = arith.addi %rot2_35, %sq2_35 : tensor<8xi16>
  %rot2_36 = tensor_ext.rotate %sum2_36, %c1 : tensor<8xi16>, index
  %sq2_36 = arith.muli %arg36, %arg36 : tensor<8xi16>
  %sum2_37 = arith.addi %rot2_36, %sq2_36 : tensor<8xi16>
  %rot2_37 = tensor_ext.rotate %sum2_37, %c1 : tensor<8xi16>, index
  %sq2_37 = arith.muli %arg37, %arg37 : tensor<8xi16>
  %sum2_38 = arith.addi %rot2_37, %sq2_37 : tensor<8xi16>
  %rot2_38 = tensor_ext.rotate %sum2_38, %c1 : tensor<8xi16>, index
  %sq2_38 = arith.muli %arg38, %arg38 : tensor<8xi16>
  %sum2_39 = arith.addi %rot2_38, %sq2_38 : tensor<8xi16>
  %rot2_39 = tensor_ext.rotate %sum2_39, %c1 : tensor<8xi16>, index
  %sq2_39 = arith.muli %arg39, %arg39 : tensor<8xi16>
  %sum2_40 = arith.addi %rot2_39, %sq2_39 : tensor<8xi16>
  %rot2_40 = tensor_ext.rotate %sum2_40, %c1 : tensor<8xi16>, index
  %sq2_40 = arith.muli %arg40, %arg40 : tensor<8xi16>
  %sum2_41 = arith.addi %rot2_40, %sq2_40 : tensor<8xi16>
  %rot2_41 = tensor_ext.rotate %sum2_41, %c1 : tensor<8xi16>, index
  %sq2_41 = arith.muli %arg41, %arg41 : tensor<8xi16>
  %sum2_42 = arith.addi %rot2_41, %sq2_41 : tensor<8xi16>
  %rot2_42 = tensor_ext.rotate %sum2_42, %c1 : tensor<8xi16>, index
  %sq2_42 = arith.muli %arg42, %arg42 : tensor<8xi16>
  %sum2_43 = arith.addi %rot2_42, %sq2_42 : tensor<8xi16>
  %rot2_43 = tensor_ext.rotate %sum2_43, %c1 : tensor<8xi16>, index
  %sq2_43 = arith.muli %arg43, %arg43 : tensor<8xi16>
  %sum2_44 = arith.addi %rot2_43, %sq2_43 : tensor<8xi16>
  %rot2_44 = tensor_ext.rotate %sum2_44, %c1 : tensor<8xi16>, index
  %sq2_44 = arith.muli %arg44, %arg44 : tensor<8xi16>
  %sum2_45 = arith.addi %rot2_44, %sq2_44 : tensor<8xi16>
  %rot2_45 = tensor_ext.rotate %sum2_45, %c1 : tensor<8xi16>, index
  %sq2_45 = arith.muli %arg45, %arg45 : tensor<8xi16>
  %sum2_46 = arith.addi %rot2_45, %sq2_45 : tensor<8xi16>
  %rot2_46 = tensor_ext.rotate %sum2_46, %c1 : tensor<8xi16>, index
  %sq2_46 = arith.muli %arg46, %arg46 : tensor<8xi16>
  %sum2_47 = arith.addi %rot2_46, %sq2_46 : tensor<8xi16>
  %rot2_47 = tensor_ext.rotate %sum2_47, %c1 : tensor<8xi16>, index
  %sq2_47 = arith.muli %arg47, %arg47 : tensor<8xi16>
  %sum2_48 = arith.addi %rot2_47, %sq2_47 : tensor<8xi16>
  %rot2_48 = tensor_ext.rotate %sum2_48, %c1 : tensor<8xi16>, index
  %sq2_48 = arith.muli %arg48, %arg48 : tensor<8xi16>
  %sum2_49 = arith.addi %rot2_48, %sq2_48 : tensor<8xi16>
  %rot2_49 = tensor_ext.rotate %sum2_49, %c1 : tensor<8xi16>, index
  %sq2_49 = arith.muli %arg49, %arg49 : tensor<8xi16>
  %sum2_50 = arith.addi %rot2_49, %sq2_49 : tensor<8xi16>
  %rot2_50 = tensor_ext.rotate %sum2_50, %c1 : tensor<8xi16>, index
  %sq2_50 = arith.muli %arg50, %arg50 : tensor<8xi16>
  %sum2_51 = arith.addi %rot2_50, %sq2_50 : tensor<8xi16>
  %rot2_51 = tensor_ext.rotate %sum2_51, %c1 : tensor<8xi16>, index
  %sq2_51 = arith.muli %arg51, %arg51 : tensor<8xi16>
  %sum2_52 = arith.addi %rot2_51, %sq2_51 : tensor<8xi16>
  %rot2_52 = tensor_ext.rotate %sum2_52, %c1 : tensor<8xi16>, index
  %sq2_52 = arith.muli %arg52, %arg52 : tensor<8xi16>
  %sum2_53 = arith.addi %rot2_52, %sq2_52 : tensor<8xi16>
  %rot2_53 = tensor_ext.rotate %sum2_53, %c1 : tensor<8xi16>, index
  %sq2_53 = arith.muli %arg53, %arg53 : tensor<8xi16>
  %sum2_54 = arith.addi %rot2_53, %sq2_53 : tensor<8xi16>
  %rot2_54 = tensor_ext.rotate %sum2_54, %c1 : tensor<8xi16>, index
  %sq2_54 = arith.muli %arg54, %arg54 : tensor<8xi16>
  %sum2_55 = arith.addi %rot2_54, %sq2_54 : tensor<8xi16>
  %rot2_55 = tensor_ext.rotate %sum2_55, %c1 : tensor<8xi16>, index
  %sq2_55 = arith.muli %arg55, %arg55 : tensor<8xi16>
  %sum2_56 = arith.addi %rot2_55, %sq2_55 : tensor<8xi16>
  %rot2_56 = tensor_ext.rotate %sum2_56, %c1 : tensor<8xi16>, index
  %sq2_56 = arith.muli %arg56, %arg56 : tensor<8xi16>
  %sum2_57 = arith.addi %rot2_56, %sq2_56 : tensor<8xi16>
  %rot2_57 = tensor_ext.rotate %sum2_57, %c1 : tensor<8xi16>, index
  %sq2_57 = arith.muli %arg57, %arg57 : tensor<8xi16>
  %sum2_58 = arith.addi %rot2_57, %sq2_57 : tensor<8xi16>
  %rot2_58 = tensor_ext.rotate %sum2_58, %c1 : tensor<8xi16>, index
  %sq2_58 = arith.muli %arg58, %arg58 : tensor<8xi16>
  %sum2_59 = arith.addi %rot2_58, %sq2_58 : tensor<8xi16>
  %rot2_59 = tensor_ext.rotate %sum2_59, %c1 : tensor<8xi16>, index
  %sq2_59 = arith.muli %arg59, %arg59 : tensor<8xi16>
  %sum2_60 = arith.addi %rot2_59, %sq2_59 : tensor<8xi16>
  %rot2_60 = tensor_ext.rotate %sum2_60, %c1 : tensor<8xi16>, index
  %sq2_60 = arith.muli %arg60, %arg60 : tensor<8xi16>
  %sum2_61 = arith.addi %rot2_60, %sq2_60 : tensor<8xi16>
  %rot2_61 = tensor_ext.rotate %sum2_61, %c1 : tensor<8xi16>, index
  %sq2_61 = arith.muli %arg61, %arg61 : tensor<8xi16>
  %sum2_62 = arith.addi %rot2_61, %sq2_61 : tensor<8xi16>
  %rot2_62 = tensor_ext.rotate %sum2_62, %c1 : tensor<8xi16>, index
  %sq2_62 = arith.muli %arg62, %arg62 : tensor<8xi16>
  %sum2_63 = arith.addi %rot2_62, %sq2_62 : tensor<8xi16>
  %m2    = arith.muli %sum2_63, %sum2_63 : tensor<8xi16>
  //-------------------------------------------------------------------------
