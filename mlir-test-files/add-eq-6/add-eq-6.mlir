func.func @func(
  ...
  //-------------------------------------------------------------------------
  // Level 6: 32 additions (5 squarings), using %arg0..%arg31
  ...
  %m6 = arith.muli %l6_32, %l6_32 : tensor<8xi16>
  //-------------------------------------------------------------------------
  // Level 7: 32 additions (6 squarings), using %arg0..%arg31
  ...
  %l7_1 = arith.addi %m6, %s7_0_6 : tensor<8xi16>
