...
int run(FuncGenerator generateCryptoContext,
  ...
  printModulusChain(cc, "form-increasing", selectionApproach);
  saveParamsToJsonFile(cc, "form-increasing", selectionApproach);
  ...
  // For form-increasing with one-hot inputs (arg0=1, others=0), each output
  // slot evaluates to 6656.
