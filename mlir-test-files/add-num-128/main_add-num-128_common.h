...
int run(FuncGenerator generateCryptoContext,
  ...
  printModulusChain(cc, "add-num-128", selectionApproach);
  saveParamsToJsonFile(cc, "add-num-128", selectionApproach);
  ...
  // add-num-128 OpenFHE currently lowers to an expression that decrypts to
  // -19361 for the initialized test vector.
  std::vector<int16_t> expected_vector(8, -19361);
  ...
  auto outputEncrypted = compute(
      ...
      encryptedArgs[65], encryptedArgs[66], encryptedArgs[67],
      encryptedArgs[68], encryptedArgs[69], encryptedArgs[70],
      encryptedArgs[71], encryptedArgs[72], encryptedArgs[73],
      encryptedArgs[74], encryptedArgs[75], encryptedArgs[76],
      encryptedArgs[77], encryptedArgs[78], encryptedArgs[79],
      encryptedArgs[80], encryptedArgs[81], encryptedArgs[82],
      encryptedArgs[83], encryptedArgs[84], encryptedArgs[85],  
      encryptedArgs[86], encryptedArgs[87], encryptedArgs[88],
      encryptedArgs[89], encryptedArgs[90], encryptedArgs[91],
      encryptedArgs[92], encryptedArgs[93], encryptedArgs[94],
      encryptedArgs[95], encryptedArgs[96], encryptedArgs[97],
      encryptedArgs[98], encryptedArgs[99], encryptedArgs[100],
      encryptedArgs[101], encryptedArgs[102], encryptedArgs[103],
      encryptedArgs[104], encryptedArgs[105], encryptedArgs[106],
      encryptedArgs[107], encryptedArgs[108], encryptedArgs[109],
      encryptedArgs[110], encryptedArgs[111], encryptedArgs[112],
      encryptedArgs[113], encryptedArgs[114], encryptedArgs[115],
      encryptedArgs[116], encryptedArgs[117], encryptedArgs[118],
      encryptedArgs[119], encryptedArgs[120], encryptedArgs[121],
      encryptedArgs[122], encryptedArgs[123], encryptedArgs[124],
      encryptedArgs[125], encryptedArgs[126], encryptedArgs[127]);
