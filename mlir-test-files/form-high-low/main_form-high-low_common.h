...
int run(FuncGenerator generateCryptoContext,
  ...
  printModulusChain(cc, "form-high-low", selectionApproach);
  saveParamsToJsonFile(cc, "form-high-low", selectionApproach);
  ...
  // reference result for each slot is 1.
  std::vector<int16_t> expected_vector(8, 4096);
