#ifndef ADD_64_4_COMMON_H
#define ADD_64_4_COMMON_H
...
int run(FuncGenerator generateCryptoContext,
  ...
  printModulusChain(cc, "add-256-4", selectionApproach);
  saveParamsToJsonFile(cc, "add-256-4", selectionApproach);
