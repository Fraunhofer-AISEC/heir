...
int run(FuncGenerator generateCryptoContext,
  ...
  printModulusChain(cc, "add-num-64", selectionApproach);
  saveParamsToJsonFile(cc, "add-num-64", selectionApproach);
  ...
  // add-num-64 OpenFHE currently lowers to an expression that decrypts to 6656
